...
if(ancho>420){	
$("#btn-whp") .mouseenter(function(evento){
	$("#tp-whp") .css("display", "block");
	$("#tp-whp") .animate({width:'220px'});
});
$("#btn-whp") .mouseleave(function(evento){
	$("#tp-whp") .css("display", "none");
});
$("#btn-mes") .mouseenter(function(evento){
	$("#tp-mes") .css("display", "block");
	$("#tp-mes") .animate({width:'220px'});
});
$("#btn-mes") .mouseleave(function(evento){
	$("#tp-mes") .css("display", "none");
});
$("#btn-pho") .mouseenter(function(evento){
	$("#tp-pho") .css("display", "block");
	$("#tp-pho") .animate({width:'220px'});
});
$("#btn-pho") .mouseleave(function(evento){
	$("#tp-pho") .css("display", "none");
});
}


/*Fin tooltips contacto*/
