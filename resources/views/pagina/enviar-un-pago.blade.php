...
<meta charset="utf-8">
    ...
    <title>Paga en línea con cualquier medio de pago servicios digitales</title>
    <meta name="description" content="Paga fácilmente tus servicios contratados con Agencia Web Bogotá usando tarjetas débito y crédito, transferencia bancaria, efectivo, paypal, skrill y bitcoin." />
	<meta name="author" content="Agencia Web Bogotá">
	<meta property="og:type" content="service" />
    <meta property="og:site_name " content="Agencia Web Bogotá" />
    <meta property="og:title" content="Paga en línea con cualquier medio de pago servicios digitales" />
    ...
    <meta property="og:description" content="Paga fácilmente tus servicios contratados con Agencia Web Bogotá usando tarjetas débito y crédito, transferencia bancaria, efectivo, paypal, skrill y bitcoin." />
    ...
    <meta name="twitter:title" content="Paga en línea con cualquier medio de pago servicios digitales">
    <meta name="twitter:description" content="Paga fácilmente tus servicios contratados con Agencia Web Bogotá usando tarjetas débito y crédito, transferencia bancaria, efectivo, paypal, skrill y bitcoin.">
	<link rel="canonical" href="https://agenciawebbogota.com/enviar-un-pago" />
	<link rel="alternate" hreflang="en_EN" href="https://en.agenciawebbogota.com/make-a-payment"/>
            ...
            <div class="dlab-bnr-inr p-t30 p-b30 no-webp-pagos webp-pagos">
                <div class="container">
                    <div class="dlab-bnr-inr-entry texto-ini">
                        ...
                        <h2 class="text-white"><span class="text-yellow">Paga seguro</span> productos servicios contratados con Agencia Web Bogotá</h2>
                    </div>
                </div>
            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="section-head text-black text-center">
                                    <h2 class="box-title font-30">Paga tus servicios de Diseño, Desarrollo Web y Marketing Digital</h2>
                                    <p class="font-weight-600 font-18">Envía un pago a Agencia Web Bogotá por cualquier servicio contratado utilizando los medios de pago disponibles.
                                        Puedes realizar pagos de diseño de páginas web, desarrollo de aplicativos, landing pages, desarrollo de tiendas online (e-commerce), renovación de hosting y dominio, 
                                    ...
                                    <div class="text-center max-w800 m-auto p-t40">
                                        ...
                                        <picture>
                                        <div class="p-t30"></div>
                                        <source srcset="{{asset('images/paypal-logo.webp')}}" type="image/webp">
                                        <img src="{{asset('images/paypal-logo.png')}}" alt="Medios de pago epayco">
                                        <div class="p-t30"></div>
                                        <span class="texto-pagos">No generamos cargos adicionales por los pagos online. Comunicate con nosotros para obtener tu referencia de pago y el valor a pagar según el servicio contratado</span>
                                    </div>
                                </picture>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-md-7 m-b30">
                                <form class="inquiry-form wow fadeInUp dzForm" data-wow-delay="0.2s"
                                    ...
                                    <h3 class="box-title m-t0 m-b10 text-center">¿Requieres asistencia con tus pagos?<span class="bg-primary"></span></h3>
