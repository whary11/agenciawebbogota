        ...
        <div class="dlab-bnr-inr overlay-primary" style="background-image:url(images/aplicativos-web.jpg);">
            <div class="container">
                <div class="dlab-bnr-inr-entry texto-ini">
					...
					<h2 class="text-white font-weight-400">Eleve la efectividad de sus trabajadores utilizando estas herramientas gratuitas</h2>
				</div>
            </div>
        </div>
								...
								<div class="max-w500 m-auto p-tb30">
									<div class="row">
										<div class="col-lg-12 text-white">
											<h3>Agencia Web Bogotá le guiará en la implementación de las Google Apps en su empresa</h3>
										</div>
									</div>
									<div class="row">
		...
		<div class="section-full content-inner bg-white">
			<div class="container">
				<div class="max-w800 m-auto text-center wow fadeIn" data-wow-delay="0.1s">
					<h6>Capacitamos a su equipo de trabajo en GSuite</h6>
					<h4 class="m-b50 ">Ya sea que cuente con experiencia en el uso de las Google Apps o recién comience, le enseñaremos como sacar el mayor provecho de estas potentes herramientas gratuitas en su empresa</h4>
				</div>
				<div class="row">
