							...
							<div class="p-a30 dis-tbl-cell wow fadeInRight" data-wow-delay="0.2s">
								<div class="max-w500 m-auto p-tb30">
									...
									<div class="row">
                                        ...
                                        <a href="{{url('https://refergsuite.app.goo.gl/rYd7')}}" class="site-button radius-xl outline white">Pruebe G Suite sin cargo durante 14 días <i class="ti-arrow-right m-l10"></i></a>
			...
			<div class="container">            
				<div class="row m-b50 equal-wraper2">					
							...
							<div class="row">
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="icon-bx-wraper  left">
										...
										<div class="icon-content">
											<h5 class="dlab-tilte">Regístrese en GSuite</h5>
										</div>
									</div>
								</div>
								<div class="col-lg-12 col-md-12 col-sm-12">
								...
								<div class="col-lg-12 col-md-12 col-sm-12">
									<div class="icon-bx-wraper  left">
										...
										<div class="icon-content">
											<h5 class="dlab-tilte">Escríbanos para obtener su código promocional</h5>
										</div>
									</div>
                                </div>
                                <div class="col-lg-12 col-md-12 col-sm-12">
                    ...
                    <div class="col-xl-6 col-lg-6 col-md-12 equal-col wow fadeInLeft m-b20" data-wow-delay="0.3s">
						<img src="images/about-us/img3.jpg" class="object-cover radius-sm" alt=""/>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="text-center max-w800 m-auto">
							<h4 class="font-weight-400 font-18">A partir de $5.4* (USD) por usuario, por mes, puede brindarle a su equipo de trabajo una solución de correo electrónico profesional, almacenamiento en línea, videoconferencias y mucho más.</h4>
							<a href="{{url('https://refergsuite.app.goo.gl/rYd7')}}" class="site-button radius-sm outline outline-2"><span class="p-lr10">¡Quiero Mi Prueba Gratuita de 14 Días!</span></a>
						</div>
					</div>
				</div>
			</div>
