    ...
    <div class="page-wraper">
                ...
                <div class="main-bar clearfix ">
                    <div class="container clearfix">
                        ...
                        <div class="logo-header">
                            <a href="https://agenciawebbogota.com"><img src="images/logo-agencia-web-bogota.svg"
        ...
        <div class="page-content bg-white" id="page">
            ...
            <div class="owl-slider-banner">
                <div class="owl-slider owl-carousel owl-theme owl-none contprin">
                    <div class="item slide-item">
                        <div class="slide-item-img"><img src="images/principal.jpg"
                                alt="Escritorio de diseñador web con elementos" /></div>
                            ...
                            <div class="slide-content-box container title-princ">
                                <div class="max-w600 text-white">
                                    ...
                                    <p>Funciones avanzadas que automatizan sus procesos, optimizan sus recursos y
                                        ...
                                        servicios.</p>
                                    <a href="sitios-web-inteligentes"
                                        class="site-button m-r10 primary button-lg btn1">Quiero Más Info</a>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="content-block">
                        ...
                        <div class="site-filters clearfix center  m-b40">
                            <ul class="filters" data-toggle="buttons">
                                <li data-filter="" class="btn active">
                                    <input type="radio">
                                    <a href="paginas-web.html" class="site-button-secondry radius-sm"><span>Diseño
                                            Web</span></a>
                                </li>
                                ...
                                <li data-filter="advertising" class="btn active">
                                    <input type="radio">
                                    <a href="#" class="site-button-secondry radius-sm"><span>Marketing en Redes
                                            Sociales</span></a>
                                </li>
                                <li data-filter="branding" class="btn">
                                    <input type="radio">
                                    <a href="#" class="site-button-secondry radius-sm"><span>Desarrollo de
                                            Apps</span></a>
                                </li>
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wow zoomIn" data-wow-delay="0.2s">
                                <div class="dlab-box-bg m-b30 box-hover"
                                    ...
                                    <div class="icon-box-btn text-center">
                                        <a href="#" class="site-button btn-block" data-toggle="modal"
                                            data-target="#exampleModal">Conozca más</a>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12 wow zoomIn" data-wow-delay="0.6s">
                                <div class="dlab-box-bg m-b30 box-hover active"
                            ...
                            <ul id="masonry"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-medefiende.jpg"
                                                    alt="Website Medefiende"> </a>
                                ...
                                <li class="advertising branding photography card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect dlab-img-effect ">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-menusfacil.jpg"
                                                    alt="Website Menús Fácil"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                ...
                                <li class="branding design photography card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-grupohelm.jpg"
                                                    alt="Website Grupo Helm"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                ...
                                <li class="web design card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-mandetextos.jpg"
                                                    alt="Tienda Online Bikers & Motos"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                ...
                                <li class="web branding card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-comfasalud.jpg"
                                                    alt="Website Comfasalud"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                ...
                                <li class="advertising design photography card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect ">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-viaggi-2.jpg"
                                                    alt="Website Pediatría Integrativa"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                                        <a href="https://pediatriaintegrativaco.com" target="_blank">
                                ...
                                <li class="web branding card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img src="images/portafolio/imagen-glaw.jpg"
                                                    alt="Website Mandetextos"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                                        <a href="https://mandetextos.com">
                                                            <h5>Mandetextos</h5>
                                                        </a>
                                ...
                                <li class="advertising design photography card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect dlab-img-effect ">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-acocine.jpg" alt="Website Acocine">
                                            </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                                        <a href="https://acocine.com" target="_blank">
                                ...
                                <li class="web photography card-container col-lg-4 col-md-6 col-sm-6 p-a0 wow zoomIn"
                                    ...
                                    <div class="dlab-box dlab-gallery-box">
                                        <div class="dlab-media dlab-img-overlay1 dlab-img-effect">
                                            <a href="javascript:void(0);"> <img
                                                    src="images/portafolio/imagen-ezry-1.jpg"
                                                    alt="website CI Export World"> </a>
                                            <div class="overlay-bx">
                                                <div class="overlay-icon align-b text-white">
                                                    <div class="text-white text-left port-box">
                                                        <a href="https://ciexportworld.com" target="_blank">
                ...
                <!-- Our Portfolio END -->
                <!-- Clients Words -->
                <div class="section-full overlay-primary-middle content-inner bg-img-fix"
                    style="background-image:url(images/Home-business-Slider-image-3.jpg)">
                    <div class="container">
        ...
        <footer class="site-footer">
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-col-4">
                            <div class="widget widget_services border-0">
                                <ul>
                                    <a href="https://agenciawebbogota.com" class="dez-page"><img
                                            src="images/logo-agencia-web-bogota.svg" alt="Logo Agencia Web Bogotá"
                                            width="300"></a>
                                    <ul>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-col-4">
                            <div class="widget widget_getintuch">
                                ...
                                <ul>
                                    <li class="text-none"><i class="fas fa-mobile-alt"></i><strong>Celular</strong>316
                                        8785601 - 304 3788629</li>
                                    <li class="text-none"><i
                                            class="fas fa-mail-bulk"></i><strong>Emails</strong>info@agenciawebbogota.com<br>proyectos@agenciawebbogota.com<br>agenciawebbogota@gmail.com
                                    </li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-col-4 ">
                            <div class="widget">
                                ...
                                <p class="m-b20 text-none">Ingrese aquí para enviar un pago a Agencia Web Bogotá usando
                                    los medios de pago disponibles en nuestra plataforma.</p>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <span class="input-group-btn">
                                                <button name="submit" value="Submit" type="submit"
                                                    class="site-button">Registrarme</button>
                                            </span>
                                        </div>
                                    </form>
                                </div>
                                <ul class="list-inline m-a0">
                                    <li><a href="https://www.facebook.com/agenciawebbogota" target="_blank"
                                            class="site-button facebook circle "><i class="fab fa-facebook-f"></i></a>
                                    </li>
                                    <li><a href="https://plus.google.com/113079972107918983296" target="_blank"
                                            class="site-button google-plus circle "><i
                                                class="fab fa-google-plus-g"></i></a></li>
                                    <li><a href="https://www.instagram.com/agenciawebbogota/" target="_blank"
                                            class="site-button instagram circle "><i class="fab fa-instagram"></i></a>
                                    </li>
                                    <li><a href="https://twitter.com/AgenciaBogota" target="_blank"
                                            class="site-button twitter circle "><i class="fab fa-twitter"></i></a></li>
                                </ul>
                            </div>
                        </div>
                    </div>
            ...
            <div class="footer-bottom bg-black">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-6 text-left text-none"> <span>Agencia Web Bogotá. Todos los
                                derechos reservados © 2019</span> </div>
