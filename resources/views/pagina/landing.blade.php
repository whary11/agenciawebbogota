...
<div class="page-wraper">
    ...
    <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="dlab-bnr-inr p-t30 p-b30 " style="background-image:url(images/ejemplos-de-landing-pages.jpg);">
            <div class="container">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="section-head text-black text-center">
								<h2 class="box-title font-30">Mejore sustancialmente los resultados de sus campañas publicitarias</h2>
								<p class="font-weight-400 font-18">Dirigir sus anuncios de Google Adwords o Facebook directamente a su página web principal, <span class="text-pink">es un grave error</span>. Para obtener los mejores resultados en sus campañas de publicidad digital, debe dirigir a sus visitantes a una página de destino o landing page</p>
							</div>							
						</div>
					</div>
				</div>
