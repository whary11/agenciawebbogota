                ...
                <div class="container">
                    <div class="row d-flex justify-content-between">
                        <div class="dlab-topbar-left">
                            <ul>
                                <li><i class="fas fa-mobile-alt m-r5"></i> 316 8785601</li>
                            </ul>
                        </div>
                        <div class="dlab-topbar-right">
                            <ul>
                                ...
                                <li><a href="pagos"><i class="fas fa-dollar-sign m-r5"></i> Enviar un Pago</a></li>
                            </ul>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-6 footer-col-4 ">
                            <div class="widget">
                                ...
                                <p class="m-b20 text-none">Compartiremos algunos consejos y herramientas útiles que le
                                    ayudarán a llegar de forma más efectiva a sus clientes</p>
